...
const Home = () => {
    return (
        <section
            className="h-full w-full relative overflow-x-hidden p-8 md:p-12 lg:flex lg:items-center lg:justify-center">
            <div className="hero flex-column gap-2  lg:w-1/2">
                ...
                <div className="relative w-full scorllbar-hide pb-3">
                    ...
                    <div className="w-full relative scrollbar-hide">
                        <List className="w-full overflow-x-hidden overflow-y-scroll flex-column gap-5 scrollbar-hide"
                              data={showcase} render={(item: IShowcae) => <Card key={item.id} data={item}/>}/>
                    </div>
                </div>
            </div>
        </section>
